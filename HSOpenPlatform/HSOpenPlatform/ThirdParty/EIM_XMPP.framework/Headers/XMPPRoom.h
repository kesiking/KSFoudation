...
@property(nonatomic,strong)NSMutableDictionary *roomMemberList;///<房间成员
@property(nonatomic,assign)NSInteger groupState;///<0,为创建,1为邀请,2为退群
@property (nonatomic,strong)NSMutableArray *nikenameList;//房间成员的nikename

@property(nonatomic,copy)NSString *moderatorsImacc;///<当前房间的房主
@property (nonatomic,copy)NSString *moderatorsnike;
