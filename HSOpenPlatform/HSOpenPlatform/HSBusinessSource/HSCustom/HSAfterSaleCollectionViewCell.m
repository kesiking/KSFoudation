...
-(void)layoutSubviews{
    ...
    [self.appIconImageView setFrame:CGRectMake((SCREEN_WIDTH/6 - 30*SCREEN_SCALE)/2, 7.5*SCREEN_SCALE, 30*SCREEN_SCALE, 30*SCREEN_SCALE)];
    [self.appNameLabel setFrame:CGRectMake(0, 43.5*SCREEN_SCALE, self.contentView.width, 10*SCREEN_SCALE)];
...
-(UILabel *)appNameLabel{
    if (!_appNameLabel) {
        ...
        self.appNameLabel.font = EHFont6;
