//
//  HSInterfaceFieldConst.h
//  HSOpenPlatform
//
//  Created by 孟希羲 on 15/10/9.
//  Copyright (c) 2015年 孟希羲. All rights reserved.
//

#ifndef HSOpenPlatform_HSInterfaceFieldConst_h
#define HSOpenPlatform_HSInterfaceFieldConst_h

static NSString * const kHSUploadUserPicApiName = @"terUserPictureAction/upLoadUserPicture.do";
...
static NSString * const kHSMyMessageInfoListApiName = @"user/showUserMsg.do";

static NSString * const kHSDeleteMyMessageInfoApiName = @"user/delUserMsg.do";

static NSString * const kHSSubscribedBussinessInfoListApiName = @"activity/listActivity.do";
